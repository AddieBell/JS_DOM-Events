...
let node2 = document.querySelectorAll(".node2");
node2[0].textContent =
...
function show() {
  ...
  // We're going to add content to the modal card
  h2.textContent = "Modal Header";
  p.textContent =
    "Clicking the button triggers the onclick event, which calls the JS function show()... which alerts the user";
  closeBtn.textContent = "Close";

  // Add an event listener that will close the modal with the button click
